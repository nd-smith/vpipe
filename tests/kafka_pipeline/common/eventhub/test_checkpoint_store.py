...
class TestCheckpointStoreConfiguration:
    ...
    def reset_module_state(self):
        ...
        from kafka_pipeline.common.eventhub.checkpoint_store import reset_checkpoint_store
    ...
    def test_load_config_from_config_file(self):
        ...
        from kafka_pipeline.common.eventhub.checkpoint_store import _load_checkpoint_config
...
class TestCheckpointStoreFactory:
    ...
    async def test_get_checkpoint_store_returns_none_when_not_configured(self):
        ...
        with patch("kafka_pipeline.common.eventhub.checkpoint_store._load_checkpoint_config") as mock_load:
    ...
    async def test_get_checkpoint_store_returns_blob_checkpoint_store_when_configured(self):
        ...
        with patch("kafka_pipeline.common.eventhub.checkpoint_store._load_checkpoint_config") as mock_load:
            ...
            with patch("kafka_pipeline.common.eventhub.checkpoint_store.BlobCheckpointStore") as mock_blob_class:
    ...
    async def test_get_checkpoint_store_caches_none_result(self):
        ...
        with patch("kafka_pipeline.common.eventhub.checkpoint_store._load_checkpoint_config", side_effect=mock_load_config):
            # First call
            store1 = await get_checkpoint_store()
...
class TestCheckpointStoreCleanup:
    ...
    async def test_close_checkpoint_store_closes_active_store(self):
        ...
        with patch("kafka_pipeline.common.eventhub.checkpoint_store._load_checkpoint_config") as mock_load2:
            mock_load2.return_value = {
                "blob_storage_connection_string": "DefaultEndpointsProtocol=https;AccountName=test;AccountKey=test123",
                "container_name": "my-checkpoints"
            }

            with patch("kafka_pipeline.common.eventhub.checkpoint_store.BlobCheckpointStore") as mock_blob_class2:
    ...
    async def test_close_checkpoint_store_safe_when_not_initialized(self):
        ...
        from kafka_pipeline.common.eventhub.checkpoint_store import close_checkpoint_store
    ...
    def test_reset_checkpoint_store_clears_state(self):
        ...
        import kafka_pipeline.common.eventhub.checkpoint_store as checkpoint_module
