...
from kafka_pipeline.verisk.workers.download_worker import DownloadWorker, TaskResult
...
class TestDownloadWorker:
    ...
    async def test_initialization(self, kafka_config, temp_download_dir):
        ...
        worker = DownloadWorker(kafka_config, domain="verisk", temp_dir=temp_download_dir)
    ...
    async def test_temp_dir_creation(self, kafka_config, tmp_path):
        ...
        worker = DownloadWorker(kafka_config, domain="verisk", temp_dir=temp_dir)
...
class TestDownloadWorkerConfig:
    ...
    async def test_default_concurrency_config(self, temp_cache_dir):
        ...
        worker = DownloadWorker(config, domain="verisk")
