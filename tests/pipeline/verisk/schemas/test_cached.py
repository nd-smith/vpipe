...
class TestCachedDownloadMessageCreation:
    ...
    def test_create_basic_message(self):
        ...
        cached = CachedDownloadMessage(
            ...
            local_cache_path="/tmp/pipeline_cache/evt-123/file.pdf",
        ...
        assert cached.local_cache_path == "/tmp/pipeline_cache/evt-123/file.pdf"
    ...
    def test_create_message_with_all_fields(self):
        ...
        cached = CachedDownloadMessage(
            ...
            local_cache_path="/tmp/pipeline_cache/evt-456/document.pdf",
    ...
    def test_create_message_without_optional_fields(self):
        ...
        cached = CachedDownloadMessage(
            ...
            local_cache_path="/tmp/pipeline_cache/evt-789/image.jpg",
...
class TestCachedDownloadMessageSerialization:
    ...
    def test_serialize_to_json(self):
        ...
        assert parsed["local_cache_path"] == "/tmp/pipeline_cache/evt-123/file.pdf"
    ...
    def test_serialize_without_optional_fields(self):
        ...
        cached = CachedDownloadMessage(
            ...
            attachment_url="https://storage.example.com/image.jpg",
            destination_path="policies/P-123/image.jpg",
            local_cache_path="/tmp/pipeline_cache/evt-456/image.jpg",
            bytes_downloaded=1024,
            event_type="policy",
            event_subtype="updated",
            status_subtype="documentsReceived",
    ...
    def test_deserialize_from_json(self):
        ...
        json_data = {
            ...
            "local_cache_path": "/tmp/pipeline_cache/evt-789/doc.pdf",
            "bytes_downloaded": 4096,
            "content_type": "application/pdf",
            "event_type": "claim",
            "event_subtype": "documentsReceived",
