...
def mock_inventory_writer():
    ...
    with patch("pipeline.verisk.workers.result_processor.DeltaInventoryWriter") as mock:
...
def mock_failed_writer():
    ...
    with patch("pipeline.verisk.workers.result_processor.DeltaFailedAttachmentsWriter") as mock:
