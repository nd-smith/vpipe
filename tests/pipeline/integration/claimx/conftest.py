...
async def claimx_event_ingester(
    ...
    monkeypatch.setattr(
        "pipeline.claimx.workers.event_ingester.ClaimXEventsDeltaWriter",
...
async def claimx_enrichment_worker(
    ...
    # Mock the API client
    monkeypatch.setattr(
        "pipeline.claimx.workers.enrichment_worker.ClaimXApiClient",
...
async def claimx_upload_worker(
    ...
    monkeypatch.setattr(
        "pipeline.claimx.workers.upload_worker.OneLakeClient",
