...
Run unit performance tests with:
    pytest tests/pipeline/claimx/performance/test_throughput.py -v -s -m "performance and not integration"

Run integration performance tests with:
    pytest tests/pipeline/claimx/performance/test_throughput.py -v -s -m "performance and integration"
...
from pipeline.claimx.schemas.tasks import ClaimXEnrichmentTask, ClaimXDownloadTask
