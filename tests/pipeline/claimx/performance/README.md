...
pytest tests/pipeline/claimx/performance/ -v -s -m performance

# Run specific test class
pytest tests/pipeline/claimx/performance/test_throughput.py::TestEnrichmentWorkerPerformance -v -s

# Run without slow E2E tests
pytest tests/pipeline/claimx/performance/ -v -s -m "performance and not slow"
```
