...
from pipeline.common.eventhub.producer import EventHubProducer, EventHubRecordMetadata
...
class TestEventHubProducerStartStop:
    ...
    async def test_start_creates_client(self, mock_eventhub_producer_client):
        ...
        with patch("pipeline.common.eventhub.producer.EventHubProducerClient") as mock_client_class:
