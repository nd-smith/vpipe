...
from pipeline.common.eventhub.consumer import EventHubConsumer, EventHubConsumerRecord
...
class TestEventHubConsumerDLQProducer:
    ...
    async def test_ensure_dlq_producer_creates_new_producer(
        ...
        with patch(
            "pipeline.common.eventhub.consumer.EventHubProducer",
...
class TestEventHubConsumerDLQSend:
    ...
    async def test_send_to_dlq_constructs_proper_message(
        ...
        with patch("pipeline.common.eventhub.consumer.socket.gethostname", return_value="test-host"):
            with patch("pipeline.common.eventhub.consumer.time.time", return_value=9999999.0):
    ...
    async def test_send_to_dlq_records_metrics(
        ...
        with patch("pipeline.common.eventhub.consumer.record_dlq_message") as mock_record:
...
class TestEventHubConsumerCheckpointStore:
    ...
    async def test_start_passes_checkpoint_store_to_client(
        ...
        with patch("pipeline.common.eventhub.consumer.EventHubConsumerClient") as mock_client_class:
