...
from pipeline.common.dlq.handler import DLQHandler
...
class TestDLQHandlerStartStop:
    ...
    @pytest.mark.asyncio
    @patch("pipeline.common.dlq.handler.BaseKafkaProducer")
    @patch("pipeline.common.dlq.handler.BaseKafkaConsumer")
