...
pytest tests/pipeline/performance/test_load_scaling.py -v
pytest tests/pipeline/performance/test_consumer_groups.py -v
pytest tests/pipeline/performance/test_peak_load.py -v -m "not extended"

# Run extended tests (long-running)
pytest tests/pipeline/performance/test_peak_load.py -v -m "extended"

# Skip slow tests
pytest tests/pipeline/performance/ -v -m "not slow"

# Generate performance reports
pytest tests/pipeline/performance/ -v --tb=short
# Reports saved to: tests/pipeline/performance/reports/
```
