...
```bash
pytest tests/pipeline/performance/ -m performance -v
```

### Full Test Suite (Including Slow Benchmarks)
```bash
pytest tests/pipeline/performance/ -m "performance or slow" -v
```

### Individual Benchmark Categories
```bash
# Throughput benchmarks
pytest tests/pipeline/performance/test_throughput.py -v

# Latency benchmarks
pytest tests/pipeline/performance/test_latency.py -v

# Resource usage benchmarks
pytest tests/pipeline/performance/test_resource_usage.py -v
```
