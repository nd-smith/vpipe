...
### 1. `pipeline/plugins/shared/base.py`
...
### 2. `pipeline/plugins/shared/registry.py`
...
### 3. `pipeline/claimx/api_client.py`
...
- `pipeline/plugins/shared/base.py` - Core action types and factories
- `pipeline/plugins/shared/registry.py` - Action execution
- `pipeline/plugins/shared/connections.py` - Connection management
- `pipeline/claimx/api_client.py` - ClaimX API client
