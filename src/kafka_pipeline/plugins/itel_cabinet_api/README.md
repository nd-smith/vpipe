...
```python
from kafka_pipeline.plugins.itel_cabinet_api.parsers import parse_cabinet_form
...
```python
from kafka_pipeline.plugins.itel_cabinet_api.pipeline import ItelCabinetPipeline
...
### "No module named 'kafka_pipeline'"
