...
Uses flatten_events() from kafka_pipeline.verisk.writers.transform.
...
from kafka_pipeline.verisk.writers.transform import flatten_events
...
class DeltaEventsWriter(BaseDeltaWriter):
    ...
    Uses flatten_events() from kafka_pipeline.verisk.writers.transform to transform
