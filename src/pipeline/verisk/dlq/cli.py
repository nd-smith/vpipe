...
Examples:
  ...
  python -m pipeline.dlq.cli list

  # List with custom limit
  python -m pipeline.dlq.cli list --limit 50

  # View specific message
  python -m pipeline.dlq.cli view evt-123

  # Replay message to pending topic
  python -m pipeline.dlq.cli replay evt-123

  # Mark message as resolved
  python -m pipeline.dlq.cli resolve evt-123
        """,
    )
